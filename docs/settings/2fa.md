...
Use Two-Factor Authentication to require an authenticator code when signing in to your account. This reduces account takeover risk if your password is exposed.
