...
3. [Review monitoring](software/monitoring/) and set alert thresholds.
4. [Check alerts](app/alerts/) for matching CVEs.
...
If something is missing or unclear, contact support at `info@cvealert.io`.
